...
class _$SettingsTearOff {
  ...
  _Settings call({required Brightness brightness}) {
    return _Settings(
...
class _$_Settings implements _Settings {
  const _$_Settings({required this.brightness});
  ...
  @override
  String toString() {
    return 'Settings(brightness: $brightness)';
  }
...
abstract class _Settings implements Settings {
  const factory _Settings({required Brightness brightness}) = _$_Settings;
